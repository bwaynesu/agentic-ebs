...
const zhHant = {
  ...
  "err.folderGone": "找不到上次的資料夾（可能被刪除、改名或搬走了）。請點右方按鈕重新選擇。",
  "err.unsupported":
  ...
  "settings.changeFolder": "更換資料夾",
  "group.folder": "資料夾與路徑",
  "group.workTime": "工作時間",
  "group.git": "Git",
  "group.prompts": "Prompt 客製化",
  "field.dataDir": "資料資料夾",
  "field.dataDirPath": "資料資料夾相對路徑（agent 從開發專案看到的位置，用於 prompt）",
  ...
  "analyze.hint": "貼給在開發專案目錄下執行的 agent，它會分析需求並寫回估時。",
...
const en = {
  ...
  "app.pickDir": "Pick folder",
  "app.pickDirRelink": "Pick / relink folder",
  ...
  "err.folderGone": "The folder you used last time is gone (deleted, renamed or moved). Use the button on the right to pick another one.",
  "err.unsupported":
  ...
  "field.dataDir": "Data folder",
  "field.dataDirPath": "Data folder relative path (where the agent sees it from your dev project; used in prompts)",
  ...
  "analyze.hint": "Paste it to an agent running in your dev project; it analyses the requirement and writes back an estimate.",
  ...
  "steps.copyImpl": "Copy for implementing agent",
  ...
  // ---- Wrap up ----
  "wrap.copy": "Copy wrap-up prompt",
  "wrap.copyAgain": "Copy wrap-up prompt (re-run)",
  "wrap.doneAny":
