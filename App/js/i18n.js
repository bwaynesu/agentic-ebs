...
const zhHant = {
  ...
  "analyze.hint": "貼給在開發專案目錄下執行的 agent，它會在 {path} 讀寫。agent 說找不到檔案，就是這個路徑不對。",
...
const en = {
  ...
  "analyze.hint": "Paste it to an agent running in your project directory; it reads and writes under {path}. If the agent cannot find the files, this path is wrong.",
